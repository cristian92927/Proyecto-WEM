<?php
  ...
  if(!empty($_POST['nombres']) && !empty($_POST['apellidos'])){
    $array = [];
    array_push($array, $_POST['correo'], $_POST['contrasena'], $_POST['nombres'], $_POST['apellidos']);
  ...
  <div class="container">
    <div class="login-box">
      ...
      <form action="" id="form" method="POST">
        ...
        <input type="password" name="contrasena" id="pw" placeholder="Contraseña" required minlength="1" maxlength="3">
